...
IMAGE_NAME="jupyter-datascience-noteboo.sif"
DEF_FILE="jupyter-datascience-notebook.def"
BASE_DIR="/fh/fast/_IRC/FHIL/grp/inhouse_computational_resources/general_workflows/compute_environments/jupyter-lab/images"
